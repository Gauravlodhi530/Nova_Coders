...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#030712] via-[#0c1329] to-[#232a46] flex items-center justify-center px-4 relative overflow-hidden">
      {/* Background Elements */}
      ...
      >
        ...
        <motion.div
          ...
          className="mb-10 p-6 bg-white/5 backdrop-blur-sm border border-cyan-400/30 rounded-2xl max-w-2xl mx-auto"
        >
          ...
          <p className="text-gray-300">
            "Every 404 is just a redirect waiting to happen. Let's get you back
        ...
        >
          {[
            ...
            >
              <Link
                to={link.to}
                className="block p-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl text-center hover:border-cyan-400/50 hover:bg-white/10 transition-all duration-300 group"
              >
                <div className="text-2xl mb-2 group-hover:scale-110 transition-transform duration-300">
                  {link.icon}
                </div>
                <div className="text-sm text-gray-300 group-hover:text-cyan-400 transition-colors duration-300">
                  {link.label}
                </div>
              </Link>
            </motion.div>
