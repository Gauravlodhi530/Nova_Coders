            ...
            >
              <Button
                ...
                onClick={() =>
                  window.scrollTo({
                    top:
                      document.getElementById("events-section").offsetTop - 100,
                    behavior: "smooth",
                  })
                }
              >
      ...
      <section className="py-16 px-6 md:px-10 lg:px-20">
        ...
        >
          ...
          >
            ...
            {/* Floating Elements */}
            <motion.div
              className="absolute top-4 right-4 w-16 h-16 bg-gradient-to-r from-cyan-400/20 to-blue-500/20 rounded-full blur-xl"
              animate={{
                scale: [1, 1.2, 1],
                opacity: [0.3, 0.6, 0.3],
              }}
            ...
            />
            <motion.div
              className="absolute bottom-4 left-4 w-20 h-20 bg-gradient-to-r from-purple-400/20 to-pink-500/20 rounded-full blur-xl"
              animate={{
                scale: [1.2, 1, 1.2],
                opacity: [0.6, 0.3, 0.6],
              }}
            ...
            <div className="relative z-10">
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Let's work together to bring your ideas to life. Whether you
                need custom development, training, or consultation, we're here
                to help you succeed.
              </motion.p>
