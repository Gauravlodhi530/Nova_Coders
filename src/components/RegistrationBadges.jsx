  ...
  const registrations = [
    {
      ...
      logo: "/public/msme-logo.png", // You'll need to add the MSME logo to public folder
      certificateNumber: "UDYAM-XX-XX-XXXXXXX", // Replace with actual certificate number
